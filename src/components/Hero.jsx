...
{/* left section */}
            <div className='w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left px-6 lg:px-16'>
                <div className='font-family flex flex-col items-center lg:items-start '>
                    <h1 className='font-family-secondary pb-6 text-xl tracking-tight lg:text-5xl text-white'>HELLO,I'M GAYASHAN.</h1>
                    <h1 className='pb-6 text-xl tracking-tight lg:text-5xl text-white mb-5'>NICE TO MEET YOU!</h1>
